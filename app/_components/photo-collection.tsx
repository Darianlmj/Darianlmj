    ...
    >
      <div className='relative'>
        ...
        <div className='flex flex-col gap-2 absolute bottom-4 left-4'>
          ...
          >
            <Link
              href={`/photography/${location.toLowerCase().split(' ').join('-')}`}
            >
              Explore
  ...
  return (
    <>
      ...
      <p className='leading-6 text-center text-sm font-medium text-slate-500'>
              Check out some of my photo collections grouped by country. Find
              out more about each photo in the collection.
      </p>
      <div className='py-6'>
