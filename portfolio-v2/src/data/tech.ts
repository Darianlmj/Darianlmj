...
export const skills: Record<string, SkillItem[]> = {
  languages: [
    ...
    {
      name: 'Rust',
      link: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/rust/rust-original.svg',
    },
    {
      name: 'PostgreSQL',
  ...
  frameworks: [
    ...
    {
      name: 'Astro',
      link: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/astro/astro-original.svg',
    },
    {
      name: 'Material UI',
